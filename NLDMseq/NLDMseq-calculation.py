...
def check_path(ref_file,input_path,output_path):
	ref_file_list=ref_file.split(',')
	for item in ref_file_list:	
...
seq_depth=Extract_GeneData.startProcess(input_path,work_path,read_length,readType,annotation_type)
